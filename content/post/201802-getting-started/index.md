...
## 2025年6月4日 更换域名为 skyao.net

将网站从香港搬回国内, 为了备案, 放弃 skyao.io 域名(备注:io域名无法备案), 启用 skyao.net 作为个人技术分享网站的域名, 将网站名从"敖小剑的博客"修改为"敖小剑的技术分享"(备注:博客是敏感词不能使用否则无法备案).

博客已经不怎么更新了, 写作的内容基本都在各种学习笔记里面,大大小小攒了一百多个,内容五花八门, 我也不做宣传, 访客一般都是来自搜索引擎.
